...
SYSTEM_PROMPT = (
    ...
    "The data field names used here (e.g. matchedCases, caseloadBreakdown, filteredCases) "
    "and the word \"context\" are INTERNAL — never mention them or expose the data structure "
    "to the user. Speak in plain, natural language. When something isn't found, say it "
    "directly, e.g. \"I couldn't find a case OS/101/2020 among your cases\" — not \"the "
    "matchedCases section has no keyword matches\".\n\n"
